...
𝕋𝕀𝕂 𝕋𝕆𝕂 : 𝕙𝕒𝕪𝕧𝕠𝕥𝕒𝕞
𝟜/𝟞/𝟚𝟘𝟚𝟛 𝕋𝕀𝕄𝔼 𝟙𝟜 : 𝟟
ℂℍ𝕌́ℂ 𝔹ℕ ℂℍ𝔸̣𝕐 𝕋𝕆𝕆𝕃 𝕄𝕌̛𝕆̛̣ℂ ℕℍ𝔼́
                   ℙℍ𝔸𝕄 ℍ𝕌𝕐ℕℍ ℚ𝕌𝔸ℕ𝔾
\033[1;37m────────────────────────────────────────────────────────────
{do}[{trang}{kt_code}{do}] {vang}BOT VIEW TIK TOK MAX SPEED 
{do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36mQUANG PHAM
{do}[{trang}{kt_code}{do}] \033[1;31mZALO: \033[1;33mhttps://zalo.me/0325506716
{do}[{trang}{kt_code}{do}] \033[1;32mAE SUPPORT: \033[1;37mQuang PHAM
{do}[{trang}{kt_code}{do}] {dac_biet}YOUTUBE:\033[1;37mQUANG PHAM
\033[1;37m────────────────────────────────────────────────────────────"""
        ...
        try:
            ...
            try:
                if response.json()['status_code'] == 0:
                    _lock.acquire()
                    print(f'{do}[{vang}PHAM HUYNH QUANG{do}] {do}[{xanh_la}BUFF VIEW SUCCESS{do}] {do}{xanh_duong}+: {trang}{success}{do} View')
                    success += 1
                    _lock.release()
            except:
